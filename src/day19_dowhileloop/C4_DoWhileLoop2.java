...
public class C4_DoWhileLoop2 {
  ...
  Kullanici yanlislikla negative sayi girerse o sayiyi toplamaya ekleme 
  ...
  */
		...
		System.out.println("tolam "+ countPoz+ " pozitif sayi girdiniz");
		System.out.println("tolam "+ countNeg+ " negatif sayi girdiniz");
