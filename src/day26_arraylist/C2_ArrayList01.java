...
public class C2_ArrayList01 {
	...
	public static void main(String[] args) {
		...
		//ArrayList bir objedir , dolayisi ile yeni bir tane olusturmak icin new keyword kullanmaliyiz
		...
		//2.yol
		ArrayList<String> list2=new ArrayList<>();//2. elmasa tio=pini yazmasak da olur
		
		//3.yol en cok bu kullanilir
		List<String> list3=new ArrayList<>();
		
		//NOT: eger constructor olarak List<>() kullanilirsa CTE verir
		//List<>() constractor kullanilmaz
		...
		//elemanlarin tek tek eklemesi gerekir.
		...
		list3.add(1, "Can");//1.index te istenen degeri ekler
