...
public class C4_Varargs03 {
	...
	public static void toplama(int sayi, int... var) { // data turunden sonra ... varags kullanacagimiz anlamina geliyor
		
		System.out.println("varargs a dahilolmayan argument : " +sayi);
