...
public class CheckMemory {
	...
	public static void main(String[] args) {
		...
		System.out.println("Loop dan onceFree Memory:" + rt.freeMemory());
		Date d = null;
		...
		// rt referans degiskeni ile JVM e garbage collector u calistirma isteginde
		// bulunalim.
	...
	// GC tum olusturalan objeleri silmeyi garanti etmedigi icin After GC Free
	// Memory farkliliklar gosterebilir.
