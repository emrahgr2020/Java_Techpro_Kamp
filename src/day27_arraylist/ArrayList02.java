...
public class ArrayList02 {
	...
	public static void main(String[] args) {
		...
		//set:istenen index deki elemani kaldirir  yeirne bizim istedigimiz elemani koyar 
		list.set(2, "Kemal");
		...
		//list.set(5, "Mustafa"); olmayan bir index kullanilirsa RTE verir
		...
		//list.add(10, "Sefer");//size den buyuk index kabul etmez hata verir RTE
